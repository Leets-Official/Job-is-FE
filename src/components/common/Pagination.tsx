  ...
  return (
    ...
    >
      <button
        ...
        className="flex h-10 w-[110px] items-center justify-center gap-1 py-0 pr-2 pl-1 text-sm text-gray-700 disabled:cursor-not-allowed disabled:opacity-50"
      >
        <ArrowLeftIcon className="size-4" /> 이전
      </button>

      <span className="flex w-[110px] items-center justify-center gap-4 text-body-medium font-medium text-gray-900">
