  ...
  return (
    ...
    >
      <Modal
        ...
        footer={
          <>
            <Button variant="outline" className="h-12 border-gray-300" onClick={onCancel}>
              취소
            </Button>
            <Button className="h-12 bg-gray-1000 text-white hover:bg-gray-800" onClick={onConfirm}>
              삭제
            </Button>
          </>
        }
